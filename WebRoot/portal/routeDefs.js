            ...
            function (
                ...
                $stateProvider
                    ...
                    .state('JYCenter', {
                        url: '/JYCenter',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['jyCenter/jyCenter.main.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'jyCenter/jyCenter.main.tpl.html',
                                controller: 'JYCenterMainCtrl'
                            }
                        }
                    })
...
//                        url: '/detail/:classinfo',
                    ...
                    //个人信息设置--照片墙
                    .state('PersonalInformation.photowall', {
                        url: '/photowall',
//                        url: '/detail/:classinfo',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['PersonalInformation/schedule/PersonalInformation.photoWall.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'PersonalInformation/schedule/PersonalInformation.photoWall.tpl.html',
                    ...
                    //个人信息设置--视频加工
                    .state('PersonalInformation.myShare', {
                        url: '/myShare',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['PersonalInformation/PersonalInformation.myShare.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'PersonalInformation/PersonalInformation.myShare.tpl.html',
                                controller: 'myShareCtrl'
                            }
                        }
                    })
                     //评课记录
                    .state('PersonalInformation.review', {
                        url: '/review',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['PersonalInformation/PersonalInformation.review.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'PersonalInformation/PersonalInformation.review.tpl.html',
                      ...
                      //听课记录
                    .state('PersonalInformation.listen', {
                        url: '/listen',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['PersonalInformation/PersonalInformation.listen.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'PersonalInformation/PersonalInformation.listen.tpl.html',
                                controller: 'listenCtrl'
                            }
                        }
                    })
                        //我的活动
                    .state('PersonalInformation.myActives', {
                        url: '/myActives',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['PersonalInformation/PersonalInformation.myActives.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'PersonalInformation/PersonalInformation.myActives.tpl.html',
                                controller: 'myActivesCtrl'
                            }
                        }
                    })
                    
                                //我的笔记
                    .state('PersonalInformation.myNotes', {
                        url: '/myNotes',
                        resolve: {
                            dummy: $couchPotatoProvider.resolveDependencies(['PersonalInformation/PersonalInformation.mynotes.ctrl'])
                        },
                        views:{
                            'main': {
                                templateUrl: 'PersonalInformation/PersonalInformation.mynotes.tpl.html',
