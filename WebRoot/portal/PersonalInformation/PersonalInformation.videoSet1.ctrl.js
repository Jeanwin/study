define(['app','config'], function (app,config) {
    app.registerController('videoSetCtrl', ['$scope','$modal','TreeService' , function ($scope,$modal,TreeService ) {
...
//                windowClass: 'modal-lg',
        ...
        var CuttingResourceModalCtrl = function($modalInstance,$scope,setOperation){
