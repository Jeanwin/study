...
<head>
    ...
    <!-- build:css ${ctx}/portal/assets/css/lemon.min.css -->
<link rel="stylesheet" href="${ctx}/portal/assets/css/bootstrap.3.1.1.css" />
<link rel="stylesheet" href="${ctx}/portal/assets/css/bootstrap-lemon.css" />
    ...
    <link rel="stylesheet" href="${ctx}/portal/assets/css/fullcalendar.css">
    ...
    <link rel="stylesheet" href="${ctx}/portal/assets/css/slick.css">

    <!-- endbuild -->
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${ctx}/portal/assets/css/normalize.css">
    <![endif]-->
    <!-- build:js ${ctx}/portal/assets/js/lemon.min.js -->
    <script src="${ctx}/portal/assets/js/modernizr.js"></script>
