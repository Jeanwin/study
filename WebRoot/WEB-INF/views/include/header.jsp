  ...
  <div class="top-bar hidden-xs" style="background:#0f97e9">
        <div class="index-top row margin-none">
            ...
            <div class="btn btn-link col-xs-1 border-none">
                <span id="login_title"><a style="color: #ffffff;font-size: 13px" href="${ctx}/login">登录</a></span>
                <span id="logout"></span>
            </div>
        </div>
    </div>
      ...
      <div class="container">
        ...
        <div role="navigation">
            <ul class="nav navbar-nav">
                ...
                <li id="pipe">|</li>
                <li>
                    <a href="/live_list.html">直播课程</a>
                </li>
                <li id="pipe">|</li>
                <li><a href="/classic_list.html">精品课程</a></li>
                <li id="pipe">|</li>
                <li><a href="/notice_list.html">通知公告</a></li>
                <li id="pipe">|</li>
                <li><a href="/active_list.html">教研中心</a></li>
            </ul>
        </div>
      </div>
    </div> 
