...
<head>
    ...
    <script type="text/javascript"
			src="${ctx}/portal/assets/js/lib/jquery-1.10.2.min.js"></script>
	<script type="text/javascript"
		src="${ctx}/portal/assets/js/bootstrap.min.js"></script>
	<script type="text/javascript">
...
<div class="whiteframe" style="margin:auto; width:auto;height:100%;padding:24px;padding-top:40px;">
    <div class="panel panel-default" style="margin:auto; width:auto;max-width:700px;height:auto;padding-left:24px;padding-top:0px;padding-left:24px;">
        ...
        <div class="panel-body">
            <div style="margin-left: 100px;margin-right: 100px">
				<form:form id="auth-form" action="${ctx}/code/resetPassword" method="post" >
				    ...
				    <div class="form-group" style="height:35px;">
	                   ...
	                   <div class="col-sm-9">
	                       <input type="password" id="password" required="required" name="password"   class="form-control" placeholder="必须由大小写字母、数字或下划线组成，长度6至16位"/>
	                       <!-- <p class="help-block" style="margin-top: 0px;">请与新密码保持一致</p> -->
	                   </div>
	               </div>
				   <div class="form-group" style="height:35px;">
