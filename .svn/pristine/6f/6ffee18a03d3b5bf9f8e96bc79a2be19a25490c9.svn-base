...
public interface ActiveMapper extends BaseMapper<Active, Integer> {
	...
	public List<Map<String, Object>> findLiveUser(String deptid);
	public List<Map<String, Object>> findClassicUser(String deptid);
	public List<Map<String, Object>> findLiveDept();
	public List<Map<String, Object>> findClassicDept();
