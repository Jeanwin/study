...
public class TeachingController {
	...
	public Map<String,String> mobileLogin(HttpServletRequest req, HttpServletResponse res, @RequestParam(required=true) String username,@RequestParam(required=true)String password){
		try {
	...
	@RequestMapping(value = "/mobile/gateway/login", method = RequestMethod.GET)
	public String mobilelog(ModelMap model){
		model.remove("error");
		return "mobile/login";
	}
	@RequestMapping(value = "/mobile/gateway/login", method = RequestMethod.POST)
	public String mobilelogPost(HttpServletRequest req, HttpServletResponse res, @RequestParam(required=true) String username,@RequestParam(required=true)String password,ModelMap model){
		try {
			Map<String,String> maps = HttpSend.login(req,res, username, password);
			if(maps != null){
