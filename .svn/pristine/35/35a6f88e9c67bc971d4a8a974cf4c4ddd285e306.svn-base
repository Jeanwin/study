define(['app'], function (app) {
    app.registerController('PersonalInformationScheduleCtrl', ['$scope','$modal','$location','ScheduleService','$timeout',
        function ($scope,$modal,$location,ScheduleService,$timeout) {
    	
    	/*$scope.gotoDetail = function(temp){
    		$scope.Jclass = JSON.parse(temp);
//    		$location.path('/PersonalInformation/detail/'+temp);
//    		$location.path('#/PersonalInformation/detail');
    	}*/
            //选择课类型
