...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "    <label for='' class='select2-offscreen'></label>",
                //"    <input type='text' onchange='getRecieverList(this.value)' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' class=''>",
                "    <input type='text' ng-change='getRecieverList()' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' class='select2-input'>",
                "  </li>",
                "</ul>",
                "<div class='select2-drop select2-drop-multi select2-display-none'>",
                //'<p><div class="select2-search"><label for="s2id_autogen1_search" class="select2-offscreen"></label><input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="select2-input form-control" style="width:500px" role="combobox" aria-expanded="true" aria-autocomplete="list" aria-owns="select2-results-1" id="s2id_autogen1_search" placeholder="搜索关键字" aria-activedescendant="select2-result-label-36"></div></p>',
                //'<input type="text" id="user_search_hidden" style="width: calc(100% - 15px); margin: 2px 6px;float: left;position: absolute;z-index: 99999;" class="form-control">',     
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "没有搜索到匹配的结果"; },
        ...
        matcher: function(term, text) {
        	//return concat(''+text).indexOf(concat(''+term)) >= 0;
