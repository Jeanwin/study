...
//	}
	...
	public String toString() {
		return "Curriculum [id=" + id + ", termid=" + termid + ", classid="
				+ classid + ", classname=" + classname + ", sameclass="
				+ sameclass + ", areaid=" + areaid + ", areano=" + areano
				+ ", areaname=" + areaname + ", userid=" + userid
				+ ", username=" + username + ", userno=" + userno + ", deptid="
				+ deptid + ", deptno=" + deptno + ", deptname=" + deptname
				+ ", date=" + date + ", startdate=" + startdate + ", enddate="
				+ enddate + ", starttime=" + starttime + ", endtime=" + endtime
				+ ", cmin=" + cmin + ", cmax=" + cmax + ", weeks=" + weeks
				+ ", weekdate=" + weekdate + ", weeksbefore=" + weeksbefore
				+ ", weeksafter=" + weeksafter + ", record=" + record
				+ ", live=" + live + ", isresource=" + isresource
				+ ", classniddlerecord=" + classniddlerecord + ", subject="
				+ subject + ", coursedesc=" + coursedesc + ", video=" + video
				+ ", livemodel=" + livemodel + ", intercourse=" + intercourse
				+ ", state=" + state
				+ ", areastate=" + areastate + ", classnum=" + classnum
				+ ", classnumbefore=" + classnumbefore + ", classnumafter="
				+ classnumafter + ", createtime=" + createtime
				+ ", modifydate=" + modifydate + ", createuser=" + createuser
				+ ", modifyuser=" + modifyuser + ", deleteflag=" + deleteflag
				+ ", excelbatch=" + excelbatch + ", flag=" + flag
				+ ", errordescribe=" + errordescribe + ", classRelation="
				+ classRelation + ", isupload=" + isupload + ", smaxclass="
				+ smaxclass + ", maxclass=" + maxclass + ", editclassbatch="
				+ editclassbatch + ", imageurl=" + imageurl + ", sort=" + sort
				+ ", uploadtime=" + uploadtime + ", resourcefloder="
				+ resourcefloder + ", uploadstatus=" + uploadstatus
