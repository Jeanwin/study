...
public class Resource implements Serializable {
	...
	public String toString() {
		return "Resource [id=" + id + ", userid=" + userid + ", username=" + username + ", areaid=" + areaid + ", areaname=" + areaname + ", curriculumid=" + curriculumid + ", deptid=" + deptid
				+ ", deptname=" + deptname + ", name=" + name + ", course=" + course + ", floder=" + floder + ", source=" + source + ", description=" + description + ", type=" + type + ", size="
				+ size + ", createdate=" + createdate + ", modifydate=" + modifydate + ", createuser=" + createuser + ", modifyuser=" + modifyuser + ", deleteflag=" + deleteflag + ", sorted="
				+ sorted + ", publishdate=" + publishdate + ", timelength=" + timelength + ", watchwatchnum=" + watchwatchnum + ", objectpos=" + objectpos + ", parentid=" + parentid + ", attribute="
				+ attribute + ", uploadstate=" + uploadstate + ", publishstate=" + publishstate + ", label=" + label + ", startdate=" + startdate + ", enddate=" + enddate + ", uploadismanual="
				+ uploadismanual + ", uploaddeletestatus=" + uploaddeletestatus + ", uploadisdelete=" + uploadisdelete + ", resourcetype=" + resourcetype + ", subject=" + subject + ", grade=" + grade
